      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-8">
          <div className="w-full lg:w-1/2 space-y-6 text-center lg:text-left">
            <div className="inline-block px-3 py-1 bg-wassalni-green/10 text-wassalni-green text-sm font-medium rounded-full animate-fade-in">
            ...
            <div className="flex items-center justify-center lg:justify-start gap-8 pt-6 animate-slide-up" style={{ animationDelay: "0.4s" }}>
              <div className="flex flex-col items-center lg:items-start">
                <span className="text-2xl font-bold text-wassalni-green">500K+</span>
                <span className="text-sm text-gray-500">Active Users</span>
              </div>
              <div className="h-10 w-px bg-gray-200"></div>
              <div className="flex flex-col items-center lg:items-start">
                <span className="text-2xl font-bold text-wassalni-green">10M+</span>
                <span className="text-sm text-gray-500">Rides Shared</span>
              </div>
              <div className="h-10 w-px bg-gray-200"></div>
              <div className="flex flex-col items-center lg:items-start">
                <span className="text-2xl font-bold text-wassalni-green">95%</span>
            ...
            <div className="relative aspect-[4/3] max-w-xl mx-auto">
              ...
              <div className="relative glass-card rounded-2xl shadow-xl overflow-hidden">
                <div className="bg-gradient-to-br from-wassalni-lightGreen to-wassalni-lightBlue p-6 text-wassalni-dark">
                  ...
                  <p className="text-wassalni-dark/80 text-sm mt-1">Where would you like to go?</p>
                </div>
                <div className="p-6 space-y-4">
                  <div className="space-y-3">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-wassalni-green/30 focus:border-wassalni-green outline-none transition-all"
